...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'domain.comum.Usuario'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'domain.comum.UsuarioPermissao'
grails.plugin.springsecurity.authority.className = 'domain.comum.Permissao'
